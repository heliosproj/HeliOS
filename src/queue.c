...
* @return               ReturnError if queue is invalid or deallocation
*                       failed
*
* @warning Using the queue handle after deletion results in undefined
* behavior
*/
...
* @return                 ReturnError if queue is empty, invalid, or
*                         allocation failed
*
* @warning Caller is responsible for freeing the allocated message structure
*/
...
* @details Sets the lock flag to prevent other tasks from modifying the
* queue.
*
