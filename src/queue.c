...
void xQueueDelete(Queue_t *queue_) {
  ...
  passed is invalid. */
  SYSASSERT(RETURN_SUCCESS == MemoryRegionCheck(HEAP_CHECK_HEALTH_AND_POINTER, queue_));
  ...
  if (RETURN_SUCCESS == MemoryRegionCheck(HEAP_CHECK_HEALTH_AND_POINTER, queue_)) {
