...
/*UNCRUSTIFY-ON*/
   ...
   * @details Allocates memory for a timer structure and initializes it with the specified period.
   *          The timer starts in suspended state and must be started explicitly.
   *
   ...
   *
   * @warning Using the timer handle after deletion results in undefined behavior
   */
   ...
   * @return ReturnError if timer is invalid or period pointer is NULL
   */
