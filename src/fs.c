...
#include "config.h"
  ...
  * @param[out] info_   Pointer to store allocated volume information
  *                     structure
  *
  * @return             ReturnOK if information was retrieved successfully
  * @return             ReturnError if volume is invalid, allocation failed,
  ...
  * @return                 ReturnError if format failed or device
  *                         unavailable
  *
  ...
  * @return              ReturnError if file is invalid or deallocation
  *                      failed
  */
  ...
  * @param[in]     origin_ Seek origin (FS_SEEK_SET, FS_SEEK_CUR,
  *                        FS_SEEK_END)
  *
  ...
  * @return             ReturnError if directory not found, allocation
  *                     failed, or invalid parameters
  *
  ...
  * @return            ReturnError if creation failed, path exists, or
  *                    invalid parameters
  */
  ...
  * @details Returns true if a file or directory exists at the specified
  * path.
  *
  * @param[in]  volume_ Pointer to the mounted volume
  ...
  *
  * @return             ReturnOK if check was successful
  * @return             ReturnError if volume is invalid or invalid
  *                     parameters
  */
