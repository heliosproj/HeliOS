 ...
 * @details Returns the size of the data portion of the specified memory block.
 *
 ...
 *
 * @warning Caller is responsible for freeing the allocated statistics structure
 */
 ...
 * @details Allocates and returns detailed statistics about kernel memory usage.
 *
 * @param[out] stats_ Pointer to store allocated statistics structure
 *
 * @return            ReturnOK if statistics were retrieved successfully
 ...
 * @details Internal memory copy implementation that handles volatile pointers.
 *
