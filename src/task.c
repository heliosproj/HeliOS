...
* @details Removes the task from the scheduler and frees its allocated
* memory.
*
...
* @details Allocates and returns detailed information about the specified
* task.
*
* @param[in]  task_ Pointer to the task to query
...
* @details Returns the execution state (running, suspended, or waiting) of
* the specified task.
*
* @param[in]  task_  Pointer to the task to query
...
* @details Returns true if the task has a notification waiting to be
* consumed.
*
* @param[in]  task_ Pointer to the task to check
* @param[out] res_  Pointer to store the result (true if notification
...
* @param[in]     value_ Pointer to notification data (can be NULL if bytes_
*                       is 0)
*
* @return               ReturnOK if notification was sent successfully
* @return               ReturnError if task is invalid, buffer full, or
*                       invalid parameters
*/
...
*                              successfully
* @return                      ReturnError if no notification pending, task
*                              is invalid, or allocation failed
*
...
*
* @return                ReturnOK if period was changed successfully
* @return                ReturnError if task is invalid or watchdog not
*                        enabled
*/
...
* @return ReturnError if scheduler is already running or initialization
*         failed
*
...
*
* @return             ReturnOK if period was retrieved successfully
* @return             ReturnError if task is invalid, watchdog not enabled,
