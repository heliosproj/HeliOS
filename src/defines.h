...
/* Define "true". We are not using "true" for boolean logic, we
   are using "true" as an integer so we do not use the (1=1) and (!TRUE)
   constructs. */
#if defined(true)
#undef true
#endif
...
/* Define "false". We are not using "false" for boolean logic, we
   are using "false" as an integer so we do not use the (1=1) and (!TRUE)
   constructs. */
#if defined(false)
#undef false
#endif
