...
/*UNCRUSTIFY-ON*/
   ...
   * @details Initializes internal state and prepares the block device for operation.
   *
   ...
   * @details Configures block device parameters, sets address for I/O operations, or retrieves device information.
   *
   * @param[in,out] device_ Pointer to device structure
   * @param[in,out] size_ Pointer to configuration data size
   * @param[in] config_ Pointer to configuration data (BlockDeviceConfig_t, BlockIORequest_t, or BlockDeviceInfo_t)
   *
   ...
   * @details Reads data from the current address position, allocates memory for the data.
   *
   * @param[in,out] device_ Pointer to device structure
