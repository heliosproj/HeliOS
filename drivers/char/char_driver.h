 ...
 * @brief Character device driver header
 * @details
 * Defines structures, commands, and function prototypes for character device drivers supporting UART, USART, and USB CDC protocols with buffering.
 *
 * @copyright
