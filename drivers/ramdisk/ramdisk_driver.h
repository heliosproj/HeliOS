 ...
 * @brief RAM disk driver header
 * @details
 * Defines structures, commands, and function prototypes for an in-memory block device driver providing volatile storage for testing and caching.
 *
 * @copyright
