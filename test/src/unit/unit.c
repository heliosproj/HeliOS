...
static void record_assertion_structured(const char *file_, int line_, assertion_type_t type_, int32_t passed_,
                                       const char *actual_expr_, unsigned long actual_val_,
                                       const char *expected_expr_, unsigned long expected_val_,
                                       const char *condition_expr_, int condition_val_);
 ...
 * These functions are called by the assertion macros in unit.h
 */
void unit_assert_equal_impl(const char *file_, int line_, unsigned long actual_, unsigned long expected_, const char *actual_expr_, const char *expected_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_EQUAL, passed,
                             actual_expr_, actual_, expected_expr_, expected_,
                             null, 0);
}
...
void unit_assert_not_equal_impl(const char *file_, int line_, unsigned long actual_, unsigned long expected_, const char *actual_expr_, const char *expected_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_NOT_EQUAL, passed,
                             actual_expr_, actual_, expected_expr_, expected_,
                             null, 0);
}
...
void unit_assert_null_impl(const char *file_, int line_, const void *ptr_, const char *ptr_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_NULL, passed,
                             ptr_expr_, (unsigned long)ptr_, "NULL", 0,
                             null, 0);
}
...
void unit_assert_not_null_impl(const char *file_, int line_, const void *ptr_, const char *ptr_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_NOT_NULL, passed,
                             ptr_expr_, (unsigned long)ptr_, "NOT_NULL", 1,
                             null, 0);
}
...
void unit_assert_true_impl(const char *file_, int line_, int condition_, const char *condition_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_TRUE, passed,
                             null, 0, null, 0,
                             condition_expr_, condition_);
}
...
void unit_assert_false_impl(const char *file_, int line_, int condition_, const char *condition_expr_) {
  ...
  record_assertion_structured(file_, line_, ASSERT_FALSE, passed,
                             null, 0, null, 0,
                             condition_expr_, condition_);
}
    ...
    if(test->assertion_count > 0) {
      ...
      for(j = 0; j < test->assertion_count; j++) {
        ...
        switch(assertion->type) {
          case ASSERT_EQUAL: type_str = "EQUAL"; break;
          case ASSERT_NOT_EQUAL: type_str = "NOT_EQUAL"; break;
          case ASSERT_NULL: type_str = "NULL"; break;
          case ASSERT_NOT_NULL: type_str = "NOT_NULL"; break;
          case ASSERT_TRUE: type_str = "TRUE"; break;
          case ASSERT_FALSE: type_str = "FALSE"; break;
        }
        ...
        if(assertion->type == ASSERT_EQUAL || assertion->type == ASSERT_NOT_EQUAL ||
           assertion->type == ASSERT_NULL || assertion->type == ASSERT_NOT_NULL) {
          fprintf(output, ",\n");
