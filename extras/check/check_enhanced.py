#!/usr/bin/env python3
"""
@file check_enhanced.py
@author Manny Peterson <manny@heliosproj.org>
@brief HeliOS Enhanced Source Code Compliance Checker with Advanced Capabilities
@version 0.6.0
@date 2025-10-24
...
- Advanced C language parser with tokenization
- Context-aware analysis engine
- Macro and preprocessor intelligence
...
# ============================================================================
# Enhanced C Parser with AST Building
# ============================================================================

class CParser:
    """Enhanced C parser that builds an AST"""
...
class EnhancedCodeParser:
    """Enhanced parser with full capabilities"""
    ...
    def parse_file(self, filepath: str, content: str) -> Dict:
        ...
        functions = self._extract_enhanced_functions(ast, content, doc_comments, context)
    ...
    def _extract_enhanced_functions(self, ast: List[ASTNode], content: str,
...
class EnhancedComplianceChecker:
    ...
    def check_file(self, filepath: str) -> FileAnalysis:
        """Check a single file with enhanced analysis"""
    ...
    def generate_report(self, analyses: List[FileAnalysis], format: str = 'text') -> str:
        ...
        if format == 'json':
            ...
            return self._generate_enhanced_text_report(analyses)

    def _generate_enhanced_text_report(self, analyses: List[FileAnalysis]) -> str:
        """Generate enhanced text report"""
        lines = []
        lines.append("=" * 80)
        lines.append("HeliOS Enhanced Compliance Report")
        lines.append("=" * 80)
    ...
    def _generate_html_report(self, analyses: List[FileAnalysis]) -> str:
        ...
        html = ['<!DOCTYPE html><html><head><title>HeliOS Compliance Report</title>']
        ...
        html.append('<h1>🔍 HeliOS Enhanced Compliance Report</h1>')
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='HeliOS Enhanced Compliance Checker',
    ...
    print(f"Checking {len(source_files)} files with enhanced analysis...")
